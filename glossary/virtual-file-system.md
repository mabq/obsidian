...
The [[on-disk-filesystem]] (on-disk structure) is the block-level layout (like ext4, Btrfs, or Zfs) formatted onto a disk/partition. It contains the actual data blocks and inodes.
